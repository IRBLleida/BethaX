...
<div class="row">
    ...
    <bx:formField bean="${this.milestone}" property="headStatistician" value="${this.milestone?.headStatistician ?: this.milestone.workPlan.projectApplication.headStatistician.id.toString()}" />
