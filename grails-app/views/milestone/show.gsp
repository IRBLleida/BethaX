...
<html>
    ...
    <body>
        ...
        <div id="show-milestone" class="content scaffold-show" role="main">
            ...
            <f:display bean="milestone" />
            <g:form resource="${this.milestone}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.milestone}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
