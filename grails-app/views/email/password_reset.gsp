...
<center style="width: 100%; background: #004020; text-align: left;">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Has demanat un reinici de contrasenya del teu usuari al software BethaX.
    </div>
        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="" style="width: 154px; height: 60px; font-family: sans-serif; font-size: 15px; line-height: 20px;" aria-hidden="true" alt="BethaX" border="0" />
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
                    ...
                    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <br><br>
                                <a href="https://bethax.udl.cat/user/newPassword/?uTok=${token}">Fes clic aquí per establir una nova contrasenya</a>
                                <br><br><br>
                                Si no et funciona l'enllaç anterior, còpia i enganxa l'adreça següent al teu navegador web:
                                <br>
                                https://bethax.udl.cat/user/newPassword/?uTok=${token}
                                <br><br><br>
                                <!-- Button : Begin -->
        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
            <tr>
                <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; line-height:18px; text-align: center; color: #888888;" class="x-gmail-data-detectors">
                    <br><br>BethaX Project<br>-<br>-<br><br>
                </td>
            </tr>
        </table>
        <!-- Email Footer : END -->
