...
<center style="width: 100%; background: #004020; text-align: left;">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Sol·licitud de serveis rebuda correctament
    </div>
        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="" style="width: 154px; height: 60px; font-family: sans-serif; font-size: 15px; line-height: 20px;" aria-hidden="true" alt="KIRBHY" border="0" />
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
                    ...
                    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                Hola,
                                <br><br>
                                Hem rebut correctament la sol·licitud de serveis.
                                <br><br>
                                <p>En breu ens posarem en contacte.</p>
                                <br><br><br>
                                <!-- Button : Begin -->
                                <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                                    <tr>
                                        <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                            <a href="----" style="background: #ed672c; border: 15px solid #ed672c; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                                <span style="color:#ffffff;" class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;KIRBHY&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                            </a>
                                        </td>
                                    </tr>
                                </table>
