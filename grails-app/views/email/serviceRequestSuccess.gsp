    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Sol·licitud de serveis rebuda correctament</span>
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <h2 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">Sol·licitud de serveis rebuda correctament</h2>
                                        <p style="margin: 0;">
                                            Hola,
                                            <br><br>
