...
<html>
    ...
    <body>
        ...
        <div id="show-projectApplication" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.projectApplication}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.projectApplication}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
