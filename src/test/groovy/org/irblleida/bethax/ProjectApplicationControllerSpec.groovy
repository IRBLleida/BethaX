...
class ProjectApplicationControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with an invalid instance"
            ...
            request.method = 'POST'
            def project = new ProjectApplication()
            project.validate()
        ...
        when:"The save action is executed with a valid instance"
            ...
            project = new ProjectApplication(params)
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            populateValidParams(params)
            def project = new ProjectApplication(params)
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        when:"A valid domain instance is passed to the update action"
            response.reset()
            populateValidParams(params)
            project = new ProjectApplication(params).save(flush: true)
            controller.update(project)
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"A domain instance is created"
            response.reset()
            populateValidParams(params)
            def project = new ProjectApplication(params).save(flush: true)
